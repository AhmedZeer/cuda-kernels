...
def main():
  ...
  for sample_num in samples_nums:
    for feature_num in features_nums:
      ...
      print()
      run_bench(sigmoid.sigmoid_fp32_launcher, a,"f32")
      run_bench(sigmoid.sigmoid_fp32x4_launcher, a, "f32x4")
      run_bench(sigmoid.sigmoid_fp32x4o_launcher, a, "f32x4o")

      print("\n", "-" * 20, "FP16", "-" * 20)
      a_16f = a.half().contiguous()

      print()
      run_bench(sigmoid.sigmoid_fp16_launcher, a_16f, "f16")
      run_bench(sigmoid.sigmoid_fp16x2o_launcher, a_16f, "f16x2o")
      run_bench(sigmoid.sigmoid_fp16x8_launcher, a_16f, "f16x8")
      run_bench(sigmoid.sigmoid_fp16x8_pack_launcher, a_16f, "f16x8_packed")
      print()
